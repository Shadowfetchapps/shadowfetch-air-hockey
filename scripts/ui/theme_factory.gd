...
static func make() -> Theme:
	...
	btn.bg_color = Color(0.06, 0.1, 0.13, 0.94)
	btn.border_color = Color(0.3, 0.62, 0.72, 0.55)
	...
	btn_h.bg_color = Color(0.1, 0.18, 0.22, 0.97)
	btn_h.border_color = Color(0.5, 0.88, 0.95, 0.9)
	var btn_p := btn.duplicate()
	btn_p.bg_color = Color(0.12, 0.24, 0.28, 0.97)
	var panel := StyleBoxFlat.new()
	panel.bg_color = Color(0.04, 0.07, 0.09, 0.93)
	panel.border_color = Color(0.2, 0.4, 0.48, 0.5)
	...
	theme.set_color("font_color", "Button", Color(0.84, 0.92, 0.95))
	theme.set_color("font_color", "Label", Color(0.8, 0.9, 0.93))
	if medium:
...
static func accent() -> Color:
	return Color(0.42, 0.86, 0.94)


static func muted() -> Color:
	return Color(0.58, 0.7, 0.74)
