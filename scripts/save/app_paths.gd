...
const APP_ID := "shadowfetch-air-hockey"


static func config_dir() -> String:
	var override := OS.get_environment("SHADOWFETCH_AIR_HOCKEY_CONFIG")
...
static func data_dir() -> String:
	var override := OS.get_environment("SHADOWFETCH_AIR_HOCKEY_DATA")
	if not override.is_empty():
		return override
