...
OPT_DIR="$HOME_DIR/.local/opt/shadowfetch-air-hockey"
SIZES=(16 22 24 32 48 64 128 256 512)
NAME="shadowfetch-air-hockey"
...
Version=1.0
Name=Shadowfetch Air Hockey
GenericName=Air Hockey
Comment=First to 7, timed, and practice for Linux
Exec=${NAME}
TryExec=${NAME}
Icon=${NAME}
Terminal=false
Categories=Game;
Keywords=air hockey;puck;mallet;shadowfetch;
StartupNotify=true
StartupWMClass=Shadowfetch Air Hockey
EOF
...
echo "Installed Shadowfetch Air Hockey launcher: $BIN_DIR/${NAME}"
